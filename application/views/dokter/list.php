                        ...
                        <tbody>
                            ...
                            foreach ($dokter as $row){
                             ...
                             <tr>
                                ...
                                ?>
                                 <td>
                                    <?php echo form_open_multipart('Dokter/status_aktif') ?>
                                    <input type="hidden" required="" name="id_dokter" value="<?=$row->id_dokter?>">
                                    <button type="submit" name="submit" class="btn btn-3d ripple-infinite btn-raised btn-primary btn-xs">
                                        <div>
                                            <span>ON</span>
                                        </div>
                                    </button>
                                    ...
                                    <?php echo form_open_multipart('Dokter/status_tidak_aktif') ?>
                                    <input type="hidden" required="" name="id_dokter" value="<?=$row->id_dokter?>">
                                    <button type="submit" name="submit" class="btn btn-3d ripple-infinite btn-raised btn-success btn-xs">
                                        <div>
                                            <span>OFF</span>
                                        </div>
                                    </button>
