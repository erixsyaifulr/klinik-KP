...
<div class="col-md-12 top-20 padding-0">
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-heading"><h3>Jumlah Pasien</h3>
            <a href="<?= site_url('Cetak') ?>" target="_blank" class="btn btn-3d ripple-infinite btn-raised btn-success btn-sm">
                        ...
                        <tbody>
                            ...
                            foreach ($daftar as $row):
                                ...
                                <td>
                                    ...
                                    ?>
                                        <span class="badge badge-warning">Masih Antri</span>
                                    <?php
                                        }
                                    ?>
