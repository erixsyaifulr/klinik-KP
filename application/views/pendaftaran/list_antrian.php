                        ...
                        <tbody>
                            ...
                            foreach ($daftar as $row):
                                ...
                                <tr>
                                    ...
                                    <?php echo anchor('Pendaftaran/hapus/' . $row->id_pasien, 'Hapus', array('class' => 'btn btn-3d ripple-infinite btn-raised btn-danger btn-sm')) ?></td>
                                <td>
                                    <?php echo form_open_multipart('Pendaftaran/selesai') ?>
                                    <input type="hidden" required="" name="id_pasien" value="<?=$row->id_pasien?>">
                                    <button type="submit" name="submit" class="btn btn-3d ripple-infinite btn-raised btn-primary btn-sm">
                                        <div>
                                            <span>Selesai</span>
                                        </div>
                                    </button>
